    ...
    stages {
        ...
        stage('Build Docker Container') {
            steps {
                ...
                docker run -d --rm --name python-tests-container -v  /var/lib/docker/volumes/jenkins-data/_data/workspace/Alexey_lesson28:/app -w /app python:3.9 tail -f /dev/null
